...
static void test_S5FIFO(gconstpointer user_data) {
  uint64_t miss_cnt_true[] = {89307, 82387, 77046, 76791, 71300, 70343, 70455, 70355};
  uint64_t miss_byte_true[] = {4040718336, 3703628800, 3354796032, 3282235904, 3038256128, 2980646912, 2984458752, 2979649536};

  reader_t *reader = (reader_t *)user_data;
  common_cache_params_t cc_params = {
      .cache_size = CACHE_SIZE, .hashpower = 20, .default_ttl = DEFAULT_TTL};
  cache_t *cache = create_test_cache("S5-FIFO", cc_params, reader, NULL);
  g_assert_true(cache != NULL);
  cache_stat_t *res = simulate_at_multi_sizes_with_step_size(
      reader, cache, STEP_SIZE, NULL, 0, 0, _n_cores());
...
static void test_S3FIFOD2(gconstpointer user_data) {
  uint64_t miss_cnt_true[] = {89307, 82387, 77041, 76791, 71300, 70343, 70455, 70355};
  uint64_t miss_byte_true[] = {4040718336, 3703628800, 3353047552, 3282235904, 3038256128, 2980646912, 2984458752, 2979649536};

  reader_t *reader = (reader_t *)user_data;
  common_cache_params_t cc_params = {
      .cache_size = CACHE_SIZE, .hashpower = 20, .default_ttl = DEFAULT_TTL};
  cache_t *cache = create_test_cache("S3-FIFO-D2", cc_params, reader, NULL);
  g_assert_true(cache != NULL);
  cache_stat_t *res = simulate_at_multi_sizes_with_step_size(
      reader, cache, STEP_SIZE, NULL, 0, 0, _n_cores());
...
static void test_S3FIFOD3(gconstpointer user_data) {
  uint64_t miss_cnt_true[] = {89307, 82387, 77041, 76791, 71300, 70343, 70455, 70355};
  uint64_t miss_byte_true[] = {4040718336, 3703628800, 3353047552, 3282235904, 3038256128, 2980646912, 2984458752, 2979649536};
  ...
  common_cache_params_t cc_params = {
      .cache_size = CACHE_SIZE, .hashpower = 20, .default_ttl = DEFAULT_TTL};
  cache_t *cache = create_test_cache("S3-FIFO-D3", cc_params, reader, NULL);
  g_assert_true(cache != NULL);
  cache_stat_t *res = simulate_at_multi_sizes_with_step_size(
      reader, cache, STEP_SIZE, NULL, 0, 0, _n_cores());
...
int main(int argc, char *argv[]) {
  ...
  g_test_add_data_func("/libCacheSim/cacheAlgo_S5FIFO", reader, test_S5FIFO);
  g_test_add_data_func("/libCacheSim/cacheAlgo_S3FIFOd2", reader, test_S3FIFOD2);
  g_test_add_data_func("/libCacheSim/cacheAlgo_S3FIFOd3", reader, test_S3FIFOD3);
