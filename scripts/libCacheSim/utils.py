...
def update_algo_name(algo):
    name_update_dict = {
        ...
        "S3FIFO_TIME_DELAY-0.1000-2": "S3FIFO_TIME",
        "S3FIFOd3-Clock2-1": "S3-FIFO-DR2",
        "S3LFUFIFO-fifo-1-0.1000-1": "S3-LFUFIFO",
        "S3LRUlru-1-0.1000-2": "S3-LRU",
        "S3LRUFIFOfifo-1-0.1000-2": "S3-LRUFIFO",
